...
USE homevalue_pricetax;
LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/addressTableData.txt' INTO TABLE addresses;

-- to load data for estimated_value_history table in mysql:
USE homevalue_pricetax;
LOAD DATA LOCAL INFILE '/docker-entrypoint-initdb.d/estimatedValueHistoryTableData.txt' INTO TABLE estimated_value_history;
